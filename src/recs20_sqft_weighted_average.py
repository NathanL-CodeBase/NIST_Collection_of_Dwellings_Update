"""
Purpose: Computes square-footage-weighted averages of dwelling characteristics from RECS
         2020 or AHS 2021 survey data and visualizes results using Bokeh.
Author: Nathan Lima
Created: 2023-09-15
"""
import json
