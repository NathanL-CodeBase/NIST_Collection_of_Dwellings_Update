"""
Purpose: Year-over-year comparison of RECS/AHS dwelling characteristic distributions
         with year-built groupings removed. Exports a Bokeh percentage-coverage HTML plot.
Author: Nathan Lima
Created: 2023-05-03
"""
import json
...
output_file(str(FIGURES_DIR / f"YearBuiltRemoved_Percentage_coverage_{dataset}.html"))
