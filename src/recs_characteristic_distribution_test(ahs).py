"""
Purpose: Validates RECS characteristic distributions against AHS data with AHS-specific
         record removals. Exports a Bokeh percentage-coverage HTML plot comparing
         RECS 2015, RECS 2020, AHS 2019, and AHS 2021.
Author: Nathan Lima
Created: 2023-05-03
"""
import json
...
output_file(str(FIGURES_DIR / f"AHSRemoved_Percentage_coverage_{dataset}.html"))
