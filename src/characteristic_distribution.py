"""
Purpose: Computes weighted distributions of dwelling characteristics from RECS 2020 or
         AHS 2021 survey data. Outputs per-type characteristic Excel and CSV tables and
         a Bokeh percentage-coverage HTML plot.
Author: Nathan Lima
Created: 2023-05-03
"""
import json
...
output_file(str(FIGURES_DIR / f"YearBuiltRemoved_Percentage_coverage_{dataset}_update.html"))
